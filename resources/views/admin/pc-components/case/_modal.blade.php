            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-outline mb-3">
                    <input type="text" required class="name form-control" id="name" name="name" autocomplete="off" placeholder="Nama Casing PC">
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="number" class="form-control" id="hddSlot" placeholder="Jumlah Slot HDD" name="hddSlot">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="number" class="form-control" id="gpuMaxLengthMm" placeholder="Max Panjang GPU (mm)" name="gpuMaxLengthMm">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-outline mb-3">
                    ...
                    <label class="form-label" for="name">Nama Casing PC</label>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                        <input type="number" class="form-control" id="hddSlot" name="hddSlot">
                        <label class="form-label" for="hddSlot">Jumlah Slot HDD</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                        <input type="number" class="form-control" id="gpuMaxLengthMm" name="gpuMaxLengthMm">
                        <label class="form-label" for="gpuMaxLengthMm">Max Panjang GPU (mm)</label>
                      </div>
                    </div>
                  </div>
                </div>
