            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-outline mb-3">
                    <input type="text" required class="name form-control" id="name" name="name" autocomplete="off" placeholder="Nama PSU">
                </div>
                <div class="row">
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="string" class="form-control" id="formFactor" placeholder="Form Factor" name="formFactor">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="string" class="form-control" id="efficiencyRating" placeholder="Efficiency Rating" name="efficiencyRating">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="num" class="form-control"  min="0" id="wattage" placeholder="Tegangan" name="wattage">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-outline mb-3">
                      <input type="text" class="form-control"  min="0" id="modular" placeholder="Modularitas" name="modular">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-outline mb-3">
                    ...
                    <label class="form-label" for="name">Nama PSU</label>
                  </div>
                  <div class="row">
                      <div class="col-lg-6">
                        <div class="form-outline mb-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                        <input type="text" class="form-control" id="efficiencyRating" name="efficiencyRating">
                        <label class="form-label" for="efficiencyRating">Efficiency Rating</label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                        <input type="num" class="form-control" id="wattage" name="wattage">
                        <label class="form-label" for="wattage" min="0">Tegangan (watt)</label>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-outline mb-3">
                        <input type="text" class="form-control" id="modular" name="modular">
                        <label class="form-label" for="modular" min="0">Modularitas</label>
                      </div>
                    </div>
                  </div>
                </div>
