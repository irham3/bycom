<script>
  ...
  $(document).ready(function () {
    $('.datatable').DataTable({
        ajax: '{{ url("admin/psu/getAllDatatable") }}',
        serverSide: false,
        processing: true,
        deferRender: true,
        type: 'GET',
  ...
  $(document).on('click', '.btn-edit', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
          ...
          $('#editModal #output-img').attr('src', '/storage/images/pc-components/psu/' + response.data.image);
          ...
          $('#editModal #efficiencyRating').val(response.data.efficiencyRating);
          $('#editModal #wattage').val(response.data.wattage);
          $('#editModal #modular').val(response.data.modular);
